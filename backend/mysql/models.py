...
class Dinosaur(Base):
  ...
  species = Column(String(25), ForeignKey("especies.name", ondelete="CASCADE"), nullable=False)
  age = Column(Integer)
  ...
  recinto = Column(String(25), ForeignKey("recinto.name", ondelete="CASCADE"), nullable=False)
...
class Recinto(Base):
  ...
  dinosaurs = relationship("Dinosaur")
